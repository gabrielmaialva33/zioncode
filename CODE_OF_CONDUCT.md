...
- Critique code, design, and behavior without attacking people.
- Assume good intent, but verify claims with tests, specs, or code references.
- Keep discussions focused on the project and the issue at hand.
- Accept maintainers' decisions when they are made after discussion.

Examples of unacceptable behavior:

- Harassment, discrimination, threats, or personal attacks.
- Sexualized language or imagery.
- Trolling, repeated derailment, or bad-faith argument.
- Publishing private information without explicit permission.
- Abusive behavior in issues, pull requests, commits, or community channels.
